...
ALTER TABLE randevu ADD COLUMN IF NOT EXISTS hizmet VARCHAR(20) NOT NULL DEFAULT 'sac';
ALTER TABLE randevu ADD COLUMN IF NOT EXISTS sure_dk INT NOT NULL DEFAULT 30;
ALTER TABLE berber ADD COLUMN IF NOT EXISTS gun_baslangic_saati SMALLINT NOT NULL DEFAULT 9;
